...
import 'package:ondemandservice/ui/login/login.dart';
...
class _DeleteProfileScreenState extends State<DeleteProfileScreen>  with TickerProviderStateMixin{
                        ...
                        child: Column(
                          children: [
                            ...
                            if (!_enablePhoneEdit)
                              SizedBox(height: 5,),
                            if (!_enablePhoneEdit)
                              Text(strings.get(305), style: theme.style12W600Orange,), /// Your phone number verified. You can't edit phone number

                            SizedBox(height: 20,),

                            Container(
                              margin: EdgeInsets.all(20),
                              child: button2(strings.get(114), theme.mainColor, _changeInfo), /// "SAVE",
                            ),
                          ],
                        ),
                      ),
  ...
  _changeInfo() async {
    ...
    var ret = await changeInfo(_editControllerName.text,
        //"+22242097204@modjidep.com", "+22242097204");
